...
#define DMWIN_MASK_UNCACHED 0x6000000000000000

// qemu puts UART registers here in virtual memory.
#define UART0 (0x1fe001e0UL | DMWIN_MASK_UNCACHED)
#define UART0_IRQ 2

#define LIOINTC_INTISR      0x1fe00000 | 0x1420 | DMWIN_MASK_UNCACHED
#define LIOINTC_INTENSET    0x1fe00000 | 0x1428 | DMWIN_MASK_UNCACHED
#define LIOINTC_INTENCLR    0x1fe00000 | 0x142c | DMWIN_MASK_UNCACHED
#define LIOINTC_INTEDGE     0x1fe00000 | 0x1434 | DMWIN_MASK_UNCACHED
#define LIOINTC_ROUTE_ENTRY10       0x1fe00000 | 0x140a | DMWIN_MASK_UNCACHED
#define LIOINTC_UART0       0xa

#define UART0_HWI 3

/* ============== LS7A registers =============== */
#define LS7A_PCH_REG_BASE (0x10000000UL | DMWIN_MASK_UNCACHED)
